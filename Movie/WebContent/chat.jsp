...
<head>
	...
	<%
		...
		if (userID.equals(URLDecoder.decode(toID, "UTF-8"))) {
			session.setAttribute("messageType", "오류 메시지");
			session.setAttribute("messageContent", "자기 자신에게는 메시지를 보낼수 없습니다.");
			response.sendRedirect("index.jsp");
			return;
		}
	...
	<script type="text/javascript">
		...
		function addChat(chatName, chatContent, chatTime) {
   		 if (chatName == '나') {
   				...
   				$('#chatList').append('<div class ="row">' +  /* chatList란 id를 가지는 div 태그 내용에 내용들을 담아줌 */
   	    				'<div class="col-lg-12">' +   /*그 내용들은 이런 식으로 들어가게됨.  */
   	    				'<div class="media">' +			/* 이 부분은 html을 분석해서 가장 깔끔하게 들어가는 형태를 분석하여 구현해야함  */
   	    				'<a class="pull-left" href="#">' +
