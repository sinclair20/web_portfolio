<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%><%@ page import="com.movie.user.UserDTO" %><%@ page import="com.movie.user.UserDAO" %>
<!DOCTYPE html>
<html>
	<%
		/* 특정한 사람의 아이디 값을 가져오기  */
...
<body>
	...
	<div class="sign-up input-group"><h5>답변 작성 양식</h5></div>
